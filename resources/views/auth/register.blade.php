...
<body>
    <div class="container">
        ...
        <div class="form-section">
            <div class="login-title">Register Page</div>
            <div class="sub-title">Sudah punya akun? <a href="{{ route('login') }}">Silahkan login</a></div>
            ...
            <form class="p-3 mt-3" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-field d-flex align-items-center position-relative">
                    ...
                    <span class="far fa-eye position-absolute" id="toggleConfirmPassword"></span>
                </div>
